...
## 1. Cluster JSON Dosyaları (238 dosya — birincil içerik kaynağı; 197 özgün + 26 aday + 14 karar/kavram + 1 kapsam dışı)
...
| `kernel-*` + `k-*` | 12 (Faz 0 atomic-types dahil) | Layer 0 kernel domain'leri | Kernel — Layer 0 |
