...
## 1. Cluster JSON Dosyaları (237 dosya — birincil içerik kaynağı; 197 özgün + 26 aday + 13 karar/kavram + 1 kapsam dışı)
...
| `kernel-*` + `k-*` | 11 (Faz 0 atomic-types dahil) | Layer 0 kernel domain'leri | Kernel — Layer 0 |
