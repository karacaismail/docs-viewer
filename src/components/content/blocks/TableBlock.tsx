...
function DataTable({
  ...
  caption?: string;
  columns: string[];
  rows: Block extends never ? never : import("../../../schemas").Segment[][][];
}) {
  return (
    ...
    <section id={id} className="tablewrap" aria-label={caption ?? "Tablo"} tabIndex={0}>
      <table>
